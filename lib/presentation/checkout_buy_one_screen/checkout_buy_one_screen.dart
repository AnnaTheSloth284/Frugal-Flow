import 'bloc/checkout_buy_one_bloc.dart';
import 'models/checkout_buy_one_model.dart';
...
class CheckoutBuyOneScreen extends StatelessWidget {
  CheckoutBuyOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<CheckoutBuyOneBloc>(
      create: (context) => CheckoutBuyOneBloc(CheckoutBuyOneState(
        checkoutBuyOneModelObj: CheckoutBuyOneModel(),
      ))
        ..add(CheckoutBuyOneInitialEvent()),
      child: CheckoutBuyOneScreen(),
    );
  }
    ...
    return SafeArea(
      child: Scaffold(
        appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: BlocSelector<CheckoutBuyOneBloc, CheckoutBuyOneState,
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              BlocSelector<CheckoutBuyOneBloc, CheckoutBuyOneState, String?>(
